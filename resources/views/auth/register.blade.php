            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{-- <form method="POST" action="{{ route('register') }}"> --}}
                        ...
                        <div class="form-group row">
                            <label for="country" class="col-md-4 col-form-label text-md-right">{{ __('Government') }}</label>

                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('email') }}" required autocomplete="phone">

                                {{-- {!! Form::select('government_id', null, ['class'=>'form-control', 'required']) !!} --}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                {{-- {!! Form::select('city_id', null, ['class'=>'form-control', 'required']) !!} --}}
